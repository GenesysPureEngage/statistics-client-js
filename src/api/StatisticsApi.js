...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.verbose verbose (default to INFO)
     ...
     */
    this.getStatValuesWithHttpInfo = function(statistics, opts) {
      opts = opts || {};
      var postBody = statistics;
     ...
     */
    this.getStatValues = function(statistics, opts) {
      return this.getStatValuesWithHttpInfo(statistics, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }

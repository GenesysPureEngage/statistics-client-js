...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Object} statistics Definitions of the statistics to monitor.
     ...
     * @param {String} objectType The type of object to which the statistic is applied.
     ...
     */
    this.getStatValueWithHttpInfo = function(objectId, objectType, statisticName) {
      var postBody = null;
     ...
     */
    this.getStatValue = function(objectId, objectType, statisticName) {
      return this.getStatValueWithHttpInfo(objectId, objectType, statisticName)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {Object} statistics The set of statistics you want to get the values of from Stat Server.

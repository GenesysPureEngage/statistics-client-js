 ...
 * Statistics Service
 *
 * OpenAPI spec version: 9.0.000.30.611
 *
...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorResponse', 'model/PeekedStatistics', 'model/ResponseStatus'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ErrorResponse'), require('./PeekedStatistics'), require('./ResponseStatus'));
  } else {
    // Browser globals (root is window)
    if (!root.StatisticsService) {
      root.StatisticsService = {};
    }
    root.StatisticsService.PeekedStatisticsResponse = factory(root.StatisticsService.ApiClient, root.StatisticsService.ErrorResponse, root.StatisticsService.PeekedStatistics, root.StatisticsService.ResponseStatus);
  }
}(this, function(ApiClient, ErrorResponse, PeekedStatistics, ResponseStatus) {
  'use strict';

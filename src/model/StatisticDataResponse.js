...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponse', 'model/ApiResponseStatus', 'model/StatisticData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ApiResponse'), require('./ApiResponseStatus'), require('./StatisticData'));
  } else {
    // Browser globals (root is window)
    if (!root.StatisticsService) {
      root.StatisticsService = {};
    }
    root.StatisticsService.StatisticDataResponse = factory(root.StatisticsService.ApiClient, root.StatisticsService.ApiResponse, root.StatisticsService.ApiResponseStatus, root.StatisticsService.StatisticData);
  }
}(this, function(ApiClient, ApiResponse, ApiResponseStatus, StatisticData) {
  'use strict';

...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ApiResponse', 'model/ApiResponseStatus', 'model/PeekedStatistic', 'model/PeekedStatisticResponse', 'model/PeekedStatisticValue', 'model/PeekedStatistics', 'model/PeekedStatisticsResponse', 'model/StatisticData', 'model/StatisticDataResponse', 'model/StatisticValue', 'api/StatisticsApi'], factory);
...
}(function(ApiClient, ApiResponse, ApiResponseStatus, PeekedStatistic, PeekedStatisticResponse, PeekedStatisticValue, PeekedStatistics, PeekedStatisticsResponse, StatisticData, StatisticDataResponse, StatisticValue, StatisticsApi) {
  'use strict';
